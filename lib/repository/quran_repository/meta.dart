import 'package:fatimid/features/quran/models/surah.dart';

class meta {
  static int ayahsCount = 6236;
  static Map surahs = {
    "count": 114,
    "references": Surah.fromApi(
      isList : true,
      surah: [
    {
      "number": 1,
  ...
  static Map sajdas = {
    ...
    "references": [
      ...
      {"surah": 32, "ayah": 15, "recommended": false, "obligatory": true},
      {"surah": 38, "ayah": 24, "recommended": true, "obligatory": false},
      {"surah": 41, "ayah": 38, "recommended": false, "obligatory": true},
      {"surah": 53, "ayah": 62, "recommended": false, "obligatory": true},
      {"surah": 84, "ayah": 21, "recommended": true, "obligatory": false},
      {"surah": 96, "ayah": 19, "recommended": false, "obligatory": true}
    ]
  };
  static Map rukus = {
    "count": 556,
